...
const PostopComplication = () => {
  ...
  const handleCalculate = () => {
    ...
    const coefficients = {
      ...
      surgeryType: [0, 0, 0.3, 0.6][formData.surgeryType],
      comorbidity: formData.comorbidity * 0.2,
      urgency: [0, 0, 0.4, 0.7][formData.urgency],
    ...
    if (score < 10) {
      ...
      interpretation = 'Low risk of postoperative complications; standard care recommended.';
    } else if (score <= 20) {
      ...
      interpretation = 'High risk; prepare for comprehensive complication management.';
    }
  ...
  return (
    <Box className="min-h-screen w-full bg-background text-foreground p-2">
      <Typography variant="h4" className="font-bold text-foreground mb-4">
        Postoperative Complication Risk Calculator
      </Typography>
      <Box className="flex items-center mb-4">
        <Info className="w-5 h-5 text-primary mr-2" />
        <Typography variant="body2" className="text-muted-foreground">
          Estimates risk of postoperative complications in cardiothoracic surgery. (Source: Nashef et al., Eur J Cardiothorac Surg 2012)
        </Typography>
      </Box>
      ...
      <Box className="card w-full max-w-2xl mx-auto p-4 bg-card text-card-foreground shadow-lg rounded-radius">
        ...
        <Box className="flex gap-4">
          ...
          >
            Calculate Postoperative Complication Risk
          </Button>
          <Button
            variant="outlined"
            onClick={handleReset}
        ...
        {result && (
          <Box className="mt-6 pt-4 border-t border-border">
            <Typography variant="h6" className="font-semibold text-card-foreground mb-2">
              Postoperative Complication Risk Score
            </Typography>
            ...
            <Box className="flex items-center mt-2">
              ...
              <Typography variant="body2" className="text-muted-foreground">
                ...
                >
                  Nashef et al., Eur J Cardiothorac Surg 2012
                </a>
              </Typography>
            </Box>
          </Box>
