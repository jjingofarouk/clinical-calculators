...
// Pneumonectomy Risk Calculator Component
// Estimates risk of mortality and complications for pneumonectomy
// Based on Bernard et al. (Ann Thorac Surg 2001;72:1949-1953)
const PneumonectomyRisk = () => {
  ...
  const ranges = {
    ...
    side: { min: 0, max: 1, type: 'integer', label: 'Side of Pneumonectomy (0 = Left, 1 = Right)' },
  };
  ...
  const helperText = {
    ...
    side: 'Side of pneumonectomy: 0 = Left, 1 = Right.',
  };
  ...
  const handleCalculate = () => {
    ...
    const coefficients = {
      ...
      fev1: formData.fev1 < 50 ? 0.6 : 0,
      dlco: formData.dlco < 50 ? 0.5 : 0,
      performanceStatus: formData.performanceStatus * 0.4,
      comorbidity: formData.comorbidity * 0.3,
      side: formData.side === '1' ? 0.4 : 0,
    };
    ...
    if (score < 10) {
      ...
      interpretation = 'Moderate risk; enhanced monitoring and pulmonary optimization advised.';
    } else {
      riskLevel = 'High Risk';
  ...
  return (
    <Box className="min-h-screen w-full bg-background text-foreground p-2">
      <Typography variant="h4" className="font-bold text-foreground mb-4">
        Pneumonectomy Risk Calculator
      </Typography>
      <Box className="flex items-center mb-4">
        <Info className="w-5 h-5 text-primary mr-2" />
        <Typography variant="body2" className="text-muted-foreground">
          Estimates risk of mortality and complications for pneumonectomy. (Source: Bernard et al., Ann Thorac Surg 2001)
        </Typography>
      </Box>
          ...
          <Box className="mt-6 pt-4 border-t border-border">
            ...
            <Box className="flex items-center mt-2">
              ...
              <Typography variant="body2" className="text-muted-foreground">
                Source:{' '}
                <a
                  href="https://pubmed.ncbi.nlm.nih.gov/11722031/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary underline"
                >
                  Bernard et al., Ann Thorac Surg 2001;72:1949-1953
                </a>
              </Typography>
            </Box>
          </Box>
...
export default PneumonectomyRisk;